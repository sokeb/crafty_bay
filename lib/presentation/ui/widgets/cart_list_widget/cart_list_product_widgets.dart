...
class _CartListProductCardState extends State<CartListProductCard> {
  ...
  Widget build(BuildContext context) {
    String produtId = widget.cartProduct.productData!.id.toString();
    return
      Card(
        color: Colors.white,
        elevation: 1,
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          '\$${cartListController.totalProductPrice[produtId]}',
                          style: const TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FittedBox(
                            child: ItemCount(
                              color: AppColors.themeColor,
                              initialValue: cartListController.quantity[produtId]!,
                              minValue: 1,
                              maxValue: 5,
                              decimalPlaces: 0,
                              onChanged: (value) {
                                int currentValue = cartListController.quantity[produtId]!;
                                if (currentValue > value) {
                                  cartListController.changeQuantity(produtId,false);
                                  setState(() {

                                  });
                                }
                                if (currentValue < value) {
                                  cartListController.changeQuantity(produtId, true);
                                  setState(() {
